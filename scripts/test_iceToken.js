...
const controller = "0x79a506D287e8488AEB4E320E6ea4b414FB973fB4"
...
const address = '0xf5a2336a282c4c4C102475f49e02A162f25F52eD'
const contract = new ethers.Contract(address, iceToken_ABI, provider)
...
const main = async () => {
    ...
    const balanceOf2 = await contract.balanceOf(controller);
...
//------------------------- NORMAL TRANSFER
    ...
    const tx = await conection.transfer(controller, 10000)
    await tx.wait()
    console.log(tx)
    ...
    const balanceOfAfter2 = await contract.balanceOf(controller);
